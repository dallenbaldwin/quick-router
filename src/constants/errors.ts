...
export enum ClientError {
   ...
   *
   * The initial aim for creating this code was using it for
   ...
   * produce a response.
   *
   * This can be sent by a server that is not configured to
   ...
   * where a client GETs a resource's state, modifies it and PUTs
